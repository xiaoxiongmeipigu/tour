 ...
 */
public class OrderItemUseAdapter extends RecyclerView.Adapter<OrderItemUseAdapter.ViewHolder> {
    ...
    public OrderItemUseAdapter(Context context, List<MapiItemResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_use_item, parent, false));
    }
