 ...
 */
public class OrderItemDiscussCompleteAdapter extends RecyclerView.Adapter<OrderItemDiscussCompleteAdapter.ViewHolder> {
    ...
    public OrderItemDiscussCompleteAdapter(Context context, List<MapiItemResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_discuss_complete_item, parent, false));
    }
