 ...
 */
public class OrderItemCancelAdapter extends RecyclerView.Adapter<OrderItemCancelAdapter.ViewHolder> {
    ...
    public OrderItemCancelAdapter(Context context, List<MapiItemResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_cancel_item, parent, false));
    }
