 ...
 */
public class PartnerCloseLayout extends LinearLayout {
    ...
    public PartnerCloseLayout(Context context) {
        super(context);
        mContext = context;
        initView();
        initListener();
    ...
    public PartnerCloseLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
        initListener();
    ...
    public PartnerCloseLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        if (isInEditMode())
            return;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_partner_close, this);
    ...
    public void onClick() {
        ControllerUtil.go2PartnerClose();
    }
}
