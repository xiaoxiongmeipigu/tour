 ...
 */
public class AllDiscussFragment extends BaseFrag {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all_discuss, container, false);
    ...
    public void load() {
        ...
        showLoading();
        ItemApi.commentlist(getActivity(), token, merchant_id,set_meal_id, "", pageIndex + "", pageNum + "", new RequestPageCallback<List<MapiDiscussResult>>() {
            @Override
