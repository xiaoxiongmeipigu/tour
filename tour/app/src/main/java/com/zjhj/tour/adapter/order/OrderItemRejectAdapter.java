 ...
 */
public class OrderItemRejectAdapter extends RecyclerView.Adapter<OrderItemRejectAdapter.ViewHolder> {
    ...
    public OrderItemRejectAdapter(Context context, List<MapiItemResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_reject_item, parent, false));
    }
