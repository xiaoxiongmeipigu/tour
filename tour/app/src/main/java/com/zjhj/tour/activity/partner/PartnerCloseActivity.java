...
public class PartnerCloseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partner_close);
    ...
    private void load() {
        ...
        showLoading();
        UserApi.userclosefriend(this, pageIndex + "", pageCount + "", new RequestPageCallback<List<MapiResourceResult>>() {
            @Override
