 ...
 */
public class HomeItemHotLayout extends RelativeLayout {
    ...
    public HomeItemHotLayout(Context context) {
        super(context);
        mContext = context;
        initView();
    }

    public HomeItemHotLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
    }

    public HomeItemHotLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        if (isInEditMode())
            return;
        view = LayoutInflater.from(mContext).inflate(R.layout.layout_home_item_hot, this);
