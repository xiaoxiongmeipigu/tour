...
import com.zjhj.commom.result.ItemsRange;
 ...
 */
public class ArrayWheelView extends View {
	 ...
	 * Constructor
	 */
	public ArrayWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public ArrayWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
