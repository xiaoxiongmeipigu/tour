...
import com.zjhj.tour.adapter.order.OrderItemCancelAdapter;
import com.zjhj.tour.adapter.order.OrderItemRejectAdapter;
 ...
 */
public class RejectedOrderFragment extends BaseFrag {
    ...
    OrderItemRejectAdapter mAdapter;

    private Integer pageIndex = 1;
    private Integer pageNum = 8;
    private Integer counts;

    public RejectedOrderFragment() {
...
//        load();
    ...
    private void initView(){
        ...
        mAdapter = new OrderItemRejectAdapter(getActivity(), mList);
    ...
    public void load() {
        showLoading();
        ItemApi.orderlist(getActivity(), "5", pageIndex + "", pageNum + "", new RequestPageCallback<List<MapiItemResult>>() {
            @Override
