 ...
 */
public class CancelOrderFragment extends BaseFrag {
    ...
    OrderItemCancelAdapter mAdapter;
...
//        load();
    ...
    private void initView(){
        ...
        mAdapter = new OrderItemCancelAdapter(getActivity(), mList);
    ...
    public void load() {
        showLoading();
        ItemApi.orderlist(getActivity(), "4", pageIndex + "", pageNum + "", new RequestPageCallback<List<MapiItemResult>>() {
            @Override
