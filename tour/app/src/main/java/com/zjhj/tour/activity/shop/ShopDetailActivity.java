    ...
    private void load() {
        ...
        ItemApi.defaultmerchant(this, id,longitude,latitude, new RequestCallback<JSONObject>() {
            ...
            public void success(JSONObject success) {
                hideLoading();
                Gson gson = new Gson();
                MapiItemResult mapiItemResult = gson.fromJson(success.getJSONObject("data").toJSONString(),MapiItemResult.class); //MapiItemResult mapiItemResult = JSONObject.parseObject(success.getJSONObject("data").toJSONString(),MapiItemResult.class);
                ...
                List<MapiDiscussResult> comment_list = gson.fromJson(success.getJSONObject("data").getJSONArray("comment_list").toJSONString(), new TypeToken<List<MapiDiscussResult>>(){}.getType());
