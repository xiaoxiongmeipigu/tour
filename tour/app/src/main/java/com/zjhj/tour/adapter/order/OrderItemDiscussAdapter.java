 ...
 */
public class OrderItemDiscussAdapter extends RecyclerView.Adapter<OrderItemDiscussAdapter.ViewHolder> {
    ...
    public OrderItemDiscussAdapter(Context context, List<MapiItemResult> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_order_discuss_item, parent, false));
    }
